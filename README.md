...
A generic MVC, AspNet Core, EntityFramework Core model referencing the 1.0.4 SDK which includes roles and event log. Supports VS Code by opening the MVC folder then running dotnet restore, dotnet build.
...
The libraries delivered by <a href="https://www.nuget.org/" target="_blank">NuGet</a> have matured to a very stable platform. Unfortunately, the rapid development of the libraries has left a lot of the existing documentation behind which is why I have published this repository.
